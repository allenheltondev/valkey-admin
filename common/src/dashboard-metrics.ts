...
export const singleMetricDescriptions = {
    ...
    total_error_replies: {
        description: "Total number of issued error replies, that is the sum of rejected commands (errors prior command execution) and failed commands (errors within the command execution).",
        unit: ""
    },
    total_watched_keys: {
